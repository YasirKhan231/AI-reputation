...
export default function IndividualSearchQuestions() {
  ...
  const socialPlatforms = [
    ...
    {
      key: "twitter",
      icon: "/b2b/search-individual/twitter.svg",
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.debugInfo}>
        ...
        <p>Selected Reason: {formData.selectedReason || "None"}</p>
        <p>First Name: {formData.personalInfo.firstName || "None"}</p>
        <p>Email: {formData.personalInfo.emailAddress || "None"}</p>
      </div>
    </div>
  );
}
